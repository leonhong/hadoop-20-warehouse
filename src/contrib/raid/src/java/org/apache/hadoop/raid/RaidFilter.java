...
public class RaidFilter {
  static class Statistics {
    private long numRaided = 0;
    private long numTooNew = 0;
    private long sizeTooNew = 0;
    private long numTooSmall = 0;
    private long sizeTooSmall = 0;
    ...
    long getSizeTooSmall() {
      return sizeTooSmall;
    }

    synchronized void incrNumRaided() {
      numRaided++;
    }

    synchronized void incrTooNew(long size) {
      numTooNew++;
      sizeTooNew += size;
    }

    synchronized void incrTooSmall(long size) {
      numTooSmall++;
      sizeTooSmall += size;
    }
